...
engine = create_engine('mysql://root:@localhost/predict_real_'+ticker.lower())
#engine = create_engine('mysql://root:reply1997@35.197.157.23/predict_real_'+ticker.lower())
