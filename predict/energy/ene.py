...
engine = create_engine('mysql://root:@localhost/predict_ene_'+ticker.lower())
#engine = create_engine('mysql://root:reply1997@35.197.157.23/predict_ene_'+ticker.lower())
...
plot.index = df['Adj Close'].tail(7).index
